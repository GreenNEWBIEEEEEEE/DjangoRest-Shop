...
class Order(models.Model):
    coupon_code = models.ForeignKey(Coupon, on_delete = models.CASCADE , blank=True, null=True)  # Field name made lowercase.
    ...
    discount_price = models.IntegerField(db_column='Discount_Price', default=0)  # Field name made lowercase.
    class Meta:
        db_table = 'Orders'
